...
#        get_response['is_modify_resting'] = data["is_modify_resting"]
    except Exception as e:
    ...
    if os.path.exists(file_path):
        paper_ecg_url = "http://192.168.2.236:1200/upload-ecg/"
        payload = {
...
def checkImage():
    ...
    try:
      ...
      if class_name == "ECG":
          ...
          #            print("Total Queue Length:", total_queue_length)
...
if __name__ == '__main__':
    port = 1600
    model_path = 'Model/restingecgModel_2.tflite'
    over_model = 'Model/Restingecg_overlap_9.tflite'
